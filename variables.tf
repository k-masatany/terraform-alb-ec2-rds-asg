variable settings {
  ...
  default = {
    ...
    "production.public_key_path"   = "./terraform-sample-04.pub"
    "staging.public_key_path"      = "./terraform-sample-04.pub"
    ...
    # ALB Settings
    "production.alb_certificate_arn" = "arn:aws:acm:xxxx"
    "staging.alb_certificate_arn"    = "arn:aws:acm:xxxx"

    # ASG Settings
    "production.asg_min_size"                  = 2
    "staging.asg_min_size"                     = 1
    "production.asg_max_size"                  = 4
    "staging.asg_max_size"                     = 1
    "production.asg_health_check_grace_period" = 300
    "staging.asg_health_check_grace_period"    = 300
    "production.asg_cpu_tracking_value"        = 60.0
    "staging.asg_cpu_tracking_value"           = 60.0
  }
}
